...
export const Conditions = () => {
    return (
        <div className='gap-20 flex flex-col items-center p-10'>
...
<div>
<h2>Article 2 – Modalités d’inscription</h2>
...
La fourniture en ligne du numéro de carte bancaire du Client et la validation finale de la commande vaudront preuve de l’accord :

–  exigibilité des sommes dues au titre de l’inscription,
...
En cas de non-paiement par l’organisme collecteur des frais de formation, le Client sera

débiteur de l’intégralité du prix de la formation et sera facturé du montant correspondant.


</p>
</div>

<h2>Article 5 – Rétractation – Modification, report ou annulation des formations</h2>

<p>Obs : 
rappelons que le droit de rétractation est applicable, depuis la loi Hamon, à tout contrat de prestation de services conclu en dehors d’un établissement commercial, par exemple, conclu au domicile du consommateur ou à son travail ou dans un espace public, ou encore dans un espace privé non habituel pour le commerce (hôtels par exemple).
Le vendeur professionnel doit communiquer à l’acheteur, avant la conclusion du contrat, un formulaire de rétractation disponible sur notre site internet, à compléter par l’acheteur.
Ce droit de rétractation est exclu pour : les contrats de services dont l’exécution a commencé, avec l’accord de l’acheteur, avant la fin du délai de rétractation.
...
En cas d’absence à la formation, de retard, de participation partielle, d’abandon ou de cessation anticipée pour tout autre motif que la force majeure, le Client sera redevable de l’intégralité du montant convenu.</p>
...
Lorsque la Plateforme est utilisée pour communiquer avec d’autres membres, les données concernant les communications de l’utilisateur font l’objet d’une conservation temporaire, ou permanent.
...
Mise en oeuvre des droits des utilisateurs<br/>
